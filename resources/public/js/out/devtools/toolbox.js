...
var args36723 = [];
var len__26140__auto___36729 = arguments.length;
var i__26141__auto___36730 = (0);
while(true){
if((i__26141__auto___36730 < len__26140__auto___36729)){
args36723.push((arguments[i__26141__auto___36730]));

var G__36731 = (i__26141__auto___36730 + (1));
i__26141__auto___36730 = G__36731;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args36723.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox36726 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox36726 = (function (obj,header,style,tag,meta36727){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox36726.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36728,meta36727__$1){
var self__ = this;
var _36728__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox36726(self__.obj,self__.header,self__.style,self__.tag,meta36727__$1));
});

devtools.toolbox.t_devtools$toolbox36726.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36728){
var self__ = this;
var _36728__$1 = this;
return self__.meta36727;
});

devtools.toolbox.t_devtools$toolbox36726.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox36726.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox36726.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox36726.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox36726.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta36727","meta36727",811618049,null)], null);
});

devtools.toolbox.t_devtools$toolbox36726.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox36726.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox36726";

devtools.toolbox.t_devtools$toolbox36726.cljs$lang$ctorPrWriter = (function (this__25671__auto__,writer__25672__auto__,opt__25673__auto__){
return cljs.core._write.call(null,writer__25672__auto__,"devtools.toolbox/t_devtools$toolbox36726");
});

devtools.toolbox.__GT_t_devtools$toolbox36726 = (function devtools$toolbox$__GT_t_devtools$toolbox36726(obj__$1,header__$1,style__$1,tag__$1,meta36727){
return (new devtools.toolbox.t_devtools$toolbox36726(obj__$1,header__$1,style__$1,tag__$1,meta36727));
});

}

return (new devtools.toolbox.t_devtools$toolbox36726(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1474437642469