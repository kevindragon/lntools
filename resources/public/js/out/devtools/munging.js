...
var o__35451__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__35463__auto__ = temp__4657__auto__;
return goog.object.get(o__35463__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__35451__auto__,"js_reserved_QMARK_").call(o__35451__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__35451__auto__ = f;
return goog.object.get(o__35451__auto__,"toString").call(o__35451__auto__);
}catch (e36084){var _ = e36084;
return "";
}});
...
try{var o__35451__auto___36087 = t;
goog.object.get(o__35451__auto___36087,"cljs$lang$ctorPrWriter").call(o__35451__auto___36087,t,writer);
}catch (e36086){var __36088 = e36086;
}
...
var char_code = (function (){var o__35451__auto__ = (new String(char$));
return goog.object.get(o__35451__auto__,"charCodeAt").call(o__35451__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__35451__auto__ = String;
return goog.object.get(o__35451__auto__,"fromCharCode").call(o__35451__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36090 = num_code;
switch (G__36090) {
case (1):
return (185);
...
var o__35451__auto__ = String;
return goog.object.get(o__35451__auto__,"fromCharCode").call(o__35451__auto__,superscript_code);
});
/**
...
}catch (e36096){var e__35476__auto__ = e36096;
return false;
}})())){
...
var vec__36097 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36097,(0),null);
...
var or__25065__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__35464__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__35463__auto__ = temp__4657__auto____$1;
return goog.object.get(o__35463__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__26140__auto___36106 = arguments.length;
var i__26141__auto___36107 = (0);
while(true){
if((i__26141__auto___36107 < len__26140__auto___36106)){
args__26147__auto__.push((arguments[i__26141__auto___36107]));

var G__36108 = (i__26141__auto___36107 + (1));
i__26141__auto___36107 = G__36108;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26148__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36102){
var vec__36103 = p__36102;
var ns_detector = cljs.core.nth.call(null,vec__36103,(0),null);
var effective_detector = (function (){var or__25065__auto__ = ns_detector;
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
var G__36109 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36110 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36109;
remaining_tokens = G__36110;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36100){
var G__36101 = cljs.core.first.call(null,seq36100);
var seq36100__$1 = cljs.core.next.call(null,seq36100);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__36101,seq36100__$1);
});
...
break;
default:
var o__35451__auto__ = window;
return goog.object.get(o__35451__auto__,"parseInt").call(o__35451__auto__,arity,(10));
...
var vec__36118 = cljs.core.split_with.call(null,(function (p1__36114_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36114_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36118,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36118,(1),null);
...
var vec__36124 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36124,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36124,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36127 = cljs.core.rest.call(null,remaining_tokens);
var G__36128 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36127;
name_tokens = G__36128;
continue;
} else {
...
var args36129 = [];
var len__26140__auto___36141 = arguments.length;
var i__26141__auto___36142 = (0);
while(true){
if((i__26141__auto___36142 < len__26140__auto___36141)){
args36129.push((arguments[i__26141__auto___36142]));

var G__36143 = (i__26141__auto___36142 + (1));
i__26141__auto___36142 = G__36143;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args36129.length)].join('')));
...
var vec__36132 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36132,(0),null);
var arity = cljs.core.nth.call(null,vec__36132,(1),null);
var vec__36135 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36135,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36135,(1),null);
var vec__36138 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36138,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36138,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36138,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36138,(3),null);
...
var args36145 = [];
var len__26140__auto___36151 = arguments.length;
var i__26141__auto___36152 = (0);
while(true){
if((i__26141__auto___36152 < len__26140__auto___36151)){
args36145.push((arguments[i__26141__auto___36152]));

var G__36153 = (i__26141__auto___36152 + (1));
i__26141__auto___36152 = G__36153;
continue;
} else {
}
break;
...
var vec__36148 = result;
var munged_ns = cljs.core.nth.call(null,vec__36148,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36148,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36148,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36148,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36148,(4),null);
var arity = cljs.core.nth.call(null,vec__36148,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__36161 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__36161,(0),null);
var args = cljs.core.nth.call(null,vec__36161,(1),null);
var vec__36164 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36164,(0),null);
var name = cljs.core.nth.call(null,vec__36164,(1),null);
...
var G__36167 = (arity + (1));
var G__36168 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36169){
var vec__36173 = p__36169;
var arity = cljs.core.nth.call(null,vec__36173,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36173,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__25065__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__36176_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36177_SHARP_);
...
var args__26147__auto__ = [];
var len__26140__auto___36184 = arguments.length;
var i__26141__auto___36185 = (0);
while(true){
if((i__26141__auto___36185 < len__26140__auto___36184)){
args__26147__auto__.push((arguments[i__26141__auto___36185]));

var G__36186 = (i__26141__auto___36185 + (1));
i__26141__auto___36185 = G__36186;
continue;
} else {
}
break;
...
var argseq__26148__auto__ = ((((1) < args__26147__auto__.length))?(new cljs.core.IndexedSeq(args__26147__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26148__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36180){
var vec__36181 = p__36180;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36181,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36178){
var G__36179 = cljs.core.first.call(null,seq36178);
var seq36178__$1 = cljs.core.next.call(null,seq36178);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__36179,seq36178__$1);
});
...
var G__36188 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__36188) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__25065__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__25053__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__25065__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36195__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36195__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36195__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36195__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36196 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36196,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36196,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36196,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36196,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36196,(4),null);
var arity = cljs.core.nth.call(null,vec__36196,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__25053__auto__ = protocol_ns;
if(cljs.core.truth_(and__25053__auto__)){
return cljs.core.not.call(null,(function (){var and__25053__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__25065__auto__ = protocol_part;
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
return fn_part;
...
var o__35451__auto__ = f;
return goog.object.get(o__35451__auto__,"getBasis").call(o__35451__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__25053__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25053__auto__)){
...
}catch (e36201){var e__35476__auto__ = e36201;
...
var G__36202 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__36203 = cljs.core.rest.call(null,path);
obj = G__36202;
path = G__36203;
continue;
} else {
...
var partition_bits = (function (){var or__25065__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
return (0);
...
return (function (accum,p__36208){
var vec__36209 = p__36208;
var bit = cljs.core.nth.call(null,vec__36209,(0),null);
var protocol = cljs.core.nth.call(null,vec__36209,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36212){
var vec__36216 = p__36212;
var ns = cljs.core.nth.call(null,vec__36216,(0),null);
var name = cljs.core.nth.call(null,vec__36216,(1),null);
var selector = cljs.core.nth.call(null,vec__36216,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__36225,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36225,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36225,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36219_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__36219_SHARP_));
});})(name,sorted_matches,vec__36225,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1474437640652