...
var len__26140__auto___36262 = arguments.length;
var i__26141__auto___36263 = (0);
while(true){
if((i__26141__auto___36263 < len__26140__auto___36262)){
args__26147__auto__.push((arguments[i__26141__auto___36263]));

var G__36264 = (i__26141__auto___36263 + (1));
i__26141__auto___36263 = G__36264;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26148__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq36260){
var G__36261 = cljs.core.first.call(null,seq36260);
var seq36260__$1 = cljs.core.next.call(null,seq36260);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__36261,seq36260__$1);
});
...
return (p1__36265_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1474437640983