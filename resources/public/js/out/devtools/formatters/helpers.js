...
var G__36230 = devtools.prefs.pref.call(null,v);
v = G__36230;
continue;
} else {
return v;
...
var and__25053__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25053__auto__){
var and__25053__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25065__auto__ = (function (){try{if(!((value == null))){
...
}catch (e36243){var e__35476__auto__ = e36243;
return false;
}})();
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
var or__25065__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e36247){var e__35476__auto__ = e36247;
return false;
}})();
...
}catch (e36249){var e__35476__auto__ = e36249;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25053__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25053__auto__)){
var and__25053__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25053__auto____$1){
...
var and__25053__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25053__auto__)){
...
var or__25065__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
var and__25053__auto__ = (function (){var or__25065__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
var vec__36254 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__36254,(0),null);
var name = cljs.core.nth.call(null,vec__36254,(1),null);
...
var and__25053__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25053__auto__)){
...
var or__25065__auto__ = typeof value === 'string';
if(or__25065__auto__){
return or__25065__auto__;
} else {
var or__25065__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__36257_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__36257_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1474437640890