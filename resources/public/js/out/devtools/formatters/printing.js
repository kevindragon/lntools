...
var len__26140__auto___36271 = arguments.length;
var i__26141__auto___36272 = (0);
while(true){
if((i__26141__auto___36272 < len__26140__auto___36271)){
args__26147__auto__.push((arguments[i__26141__auto___36272]));

var G__36273 = (i__26141__auto___36272 + (1));
i__26141__auto___36272 = G__36273;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26148__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq36268){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__36269,G__36270,seq36268__$2);
});
...
if(cljs.core.truth_((function (){var or__25065__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25671__auto__,writer__25672__auto__,opt__25673__auto__){
return cljs.core._write.call(null,writer__25672__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25053__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25053__auto__){
var or__25065__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__36274_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__36274_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__36283__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25065__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e36287){var e__35476__auto__ = e36287;
return false;
}})();
if(cljs.core.truth_(or__25065__auto__)){
return or__25065__auto__;
...
}catch (e36289){var e__35476__auto__ = e36289;
return false;
}}
})())){
...
var _STAR_current_state_STAR_36294 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__36295 = opts;
...
var markup_db = cljs.core.get.call(null,map__36295__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_36294;
}});
...
;
var temp__4655__auto___36300 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___36300)){
var managed_print_level_36301 = temp__4655__auto___36300;
var _STAR_print_level_STAR_36299_36302 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_36301;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_36299_36302,managed_print_level_36301,temp__4655__auto___36300,writer,opts,job_fn){
return (function (p1__36297_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__36297_SHARP_,null);
});})(_STAR_print_level_STAR_36299_36302,managed_print_level_36301,temp__4655__auto___36300,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_36299_36302;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1474437641189