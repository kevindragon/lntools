...
var vec__36441_36444 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_36445 = cljs.core.nth.call(null,vec__36441_36444,(0),null);
var only_after_36446 = cljs.core.nth.call(null,vec__36441_36444,(1),null);
var db_changed_QMARK__36447 = (cljs.core.some_QMARK_.call(null,only_before_36445)) || (cljs.core.some_QMARK_.call(null,only_after_36446));
if(db_changed_QMARK__36447){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_36445);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_36446);
...
var map__36454 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__36454__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__36454__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__36462 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__36462__$1;
var event = cljs.core.get.call(null,map__36462__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26140__auto___36465 = arguments.length;
var i__26141__auto___36466 = (0);
while(true){
if((i__26141__auto___36466 < len__26140__auto___36465)){
args__26147__auto__.push((arguments[i__26141__auto___36466]));

var G__36467 = (i__26141__auto___36466 + (1));
i__26141__auto___36466 = G__36467;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26148__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq36464){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36464));
});
...
var args__26147__auto__ = [];
var len__26140__auto___36473 = arguments.length;
var i__26141__auto___36474 = (0);
while(true){
if((i__26141__auto___36474 < len__26140__auto___36473)){
args__26147__auto__.push((arguments[i__26141__auto___36474]));

var G__36475 = (i__26141__auto___36474 + (1));
i__26141__auto___36474 = G__36475;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26148__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__36468_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__36469_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__36469_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq36470){
var G__36471 = cljs.core.first.call(null,seq36470);
var seq36470__$1 = cljs.core.next.call(null,seq36470);
var G__36472 = cljs.core.first.call(null,seq36470__$1);
var seq36470__$2 = cljs.core.next.call(null,seq36470__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__36471,G__36472,seq36470__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1474379738544