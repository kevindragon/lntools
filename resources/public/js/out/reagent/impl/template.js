...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25671__auto__,writer__25672__auto__,opt__25673__auto__){
return cljs.core._write.call(null,writer__25672__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28127 = o;
(G__28127[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__25053__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__25053__auto__){
var and__25053__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25053__auto____$1){
var and__25053__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__28135 = jsprops;
(G__28135["defaultValue"] = value);

(G__28135["onChange"] = ((function (G__28135,v,value,on_change){
return (function (p1__28133_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28133_SHARP_);
});})(G__28135,v,value,on_change))
);
...
var vec__28142 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28142,(0),null);
var id = cljs.core.nth.call(null,vec__28142,(1),null);
var class$ = cljs.core.nth.call(null,vec__28142,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28147 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28147 == null)){
} else {
var key_28148 = temp__4661__auto___28147;
(jsprops["key"] = key_28148);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28150 = (new reagent.impl.template.NativeWrapper());
(G__28150["name"] = c);
...
var len__26140__auto___28156 = arguments.length;
var i__26141__auto___28157 = (0);
while(true){
if((i__26141__auto___28157 < len__26140__auto___28156)){
args__26147__auto__.push((arguments[i__26141__auto___28157]));

var G__28158 = (i__26141__auto___28157 + (1));
i__26141__auto___28157 = G__28158;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26148__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28154){
var G__28155 = cljs.core.first.call(null,seq28154);
var seq28154__$1 = cljs.core.next.call(null,seq28154);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28155,seq28154__$1);
});
...
break;
default:
var G__28162 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28162;
continue;
...
var n__25980__auto___28165 = a.length;
var i_28166 = (0);
while(true){
if((i_28166 < n__25980__auto___28165)){
(a[i_28166] = reagent.impl.template.as_element.call(null,(a[i_28166])));

var G__28167 = (i_28166 + (1));
i_28166 = G__28167;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25980__auto___28168 = a.length;
var i_28169 = (0);
while(true){
if((i_28169 < n__25980__auto___28168)){
var val_28170 = (a[i_28169]);
if((cljs.core.vector_QMARK_.call(null,val_28170)) && ((reagent.impl.template.key_from_vec.call(null,val_28170) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28169] = reagent.impl.template.as_element.call(null,val_28170));

var G__28171 = (i_28169 + (1));
i_28169 = G__28171;
continue;
} else {
}
...
var ctx = ({});
var vec__28175 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28175,(0),null);
var derefed = cljs.core.nth.call(null,vec__28175,(1),null);
...
var G__28179 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28179) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28179){
...
//# sourceMappingURL=template.js.map?rel=1474379725813