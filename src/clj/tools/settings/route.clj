...
(def routes
  (c/routes
    ...
    (c/GET "/data-gap" [] (data-gap/data-gaps))
    (c/PUT "/data-gap" {:keys [params]} (data-gap/add params))
    (c/DELETE "/data-gap" {:keys [params]} (data-gap/delete params))
